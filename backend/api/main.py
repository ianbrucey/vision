...
def _apply_schemas():
    ...
    ensure_vendor_teaming_agreements_schema()  # 032 — MTA/BSTA/subcontract rows + case-less documents
...
from api.routes.vendor_agreements import router as vendor_agreements_router
...
app.include_router(vendor_agreements_router)

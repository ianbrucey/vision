...
potential subcontractor or supplier. The goal is to start a conversation,
not to dump the full solicitation. Follow these rules:

SUBJECT — 8 words max, no NAICS code:
  Format: "[Product/need] — [Agency] [RFQ/RFP #]"
  Example: "Snowmobile supply — USDA Forest Service RFQ 12444526Q0056"
  The RFQ/RFP number alone tells them it's real. The product tells them
  whether to keep reading.

BODY — 5 short paragraphs max:
  1. What we need — 2-3 sentences. State the product, quantity, buyer,
     and the 3-4 specs that would immediately disqualify someone (e.g.
     "turbocharged mountain snowmobile, 154"+ track"). Mention
     brand-name-or-equal if applicable — it's the most valuable signal to
     a supplier. Do NOT list every compliance requirement.
  2. What we're looking for — 1 sentence. Supplier? Teaming partner?
     Be specific about the role.
  3. Why them — 1 sentence. Use the LITERAL placeholder {{match_reason}}.
     The LLM's match_rationale should be a factual, one-sentence
     observation about their capabilities, not flattery. If the rationale
     is thin, acknowledge it: "Your firm surfaced because of [X]" rather
     than pretending it's a perfect match.
  4. Call to action — 1 sentence. Include a deadline or timeframe if the
     solicitation has one (question deadline, response deadline). "We'd
     want to connect before [date]" creates urgency. If no deadline is
     known, ask for a reply within a week.
  5. Closing — sign as "Ian Bruce, Justice Quest LLC" with the actual
     reply-to address. Use the LITERAL placeholder {{vendor_name}} in the
     salutation ONLY (e.g. "{{vendor_name}} team," or just "Hello,").
     Do NOT use {{vendor_name}} or {{match_reason}} anywhere else.

TONE — direct, factual, human. Write like an email you'd actually send to
a peer. No:
  - "We believe your capabilities would be a valuable asset"
  - "We look forward to the possibility of working together"
  - "Strong potential partner" / "esteemed organization"
  - Anything that sounds like it was generated by a procurement bot
Do:
  - State facts plainly
